<x-app-layout>
    @if (session('status') === 'profile-updated')
        ...
        <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
             class="pointer-events-auto relative rounded-sm border border-[#385c35] bg-white text-[#385c35] "
            ...
            <div class="flex w-full items-center gap-2.5 bg-[#f5f1e3]  rounded-sm p-4 transition-all duration-300">
