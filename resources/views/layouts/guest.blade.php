    ...
    <div class="container mx-auto  py-20">
        <div class="grid grid-cols-1 sm:grid-cols-2  ">
            <div class="hidden sm:flex ml-10">
                <!-- Date Card Component -->
                <div
                    class="w-96 h-[80vh] agrilink-bg rounded-3xl overflow-hidden shadow-lg flex relative border  border-[#385c35]">
                    ...
                    <div class="w-1/2 bg-white p-6 flex flex-col relative overflow-hidden">
                        ...
                        <div
                            class="pr-3 absolute -left-20 top-24 w-[43vh] h-[43vh] rounded-full bg-gradient-to-br from-orange-300 to-orange-500 opacity-90"></div>
                    </div>
                </div>
