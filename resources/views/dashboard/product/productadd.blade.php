            ...
            <form method="post" action="{{ route('product.store') }}" class="mt-6 space-y-6">
                ...
                <div class="grid sm:grid-cols-2 grid-cols-1 gap-5 ">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="description" name="description" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm" required>{{ old('description') }}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <select id="measurement_unit" name="measurement_unit" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm" required>
                            ...
                            <option value="kg" {{ old('measurement_unit') == 'kg' ? 'selected' : '' }}>kg (Kilogram)</option>
                            <option value="g" {{ old('measurement_unit') == 'g' ? 'selected' : '' }}>g (Gram)</option>
                            <option value="lb" {{ old('measurement_unit') == 'lb' ? 'selected' : '' }}>lb (Pound)</option>
                            <option value="oz" {{ old('measurement_unit') == 'oz' ? 'selected' : '' }}>oz (Ounce)</option>
                            <option value="l" {{ old('measurement_unit') == 'l' ? 'selected' : '' }}>l (Liter)</option>
                            <option value="ml" {{ old('measurement_unit') == 'ml' ? 'selected' : '' }}>ml (Milliliter)</option>
                            <option value="piece" {{ old('measurement_unit') == 'piece' ? 'selected' : '' }}>Piece</option>
                            <option value="dozen" {{ old('measurement_unit') == 'dozen' ? 'selected' : '' }}>Dozen</option>
                            <option value="bunch" {{ old('measurement_unit') == 'bunch' ? 'selected' : '' }}>Bunch</option>
                            ...
                            <option value="crate" {{ old('measurement_unit') == 'crate' ? 'selected' : '' }}>Crate</option>
                        </select>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid sm:grid-cols-2 grid-cols-1 gap-5 w-auto">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="retail_price" class="block mt-1 w-full" type="number" step="0.01" name="retail_price" :value="old('retail_price')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="quantity_available" class="block mt-1 w-full" type="number" name="quantity_available" :value="old('quantity_available')" required />
